...
export const QuizProvider = ({ children }) => {
  const [responses, setResponses] = useState([
    ...
    { question_id: 2, selected_option: "Yes" },
    { question_id: 3, selected_option: "Yes" },
    { question_id: 4, selected_option: "Yes" },
    { question_id: 5, selected_option: "Yes" },
    { question_id: 6, selected_option: "Yes" },
    { question_id: 7, selected_option: "Yes" },
    { question_id: 8, selected_option: "Yes" },
    { question_id: 9, selected_option: "Yes" },
    { question_id: 10, selected_option: "Yes" },
    { question_id: 11, selected_option: "Yes" },
    { question_id: 12, selected_option: "Yes" },
    { question_id: 13, selected_option: "Yes" },
    { question_id: 14, selected_option: "Yes" },
    { question_id: 15, selected_option: "Yes" },
    { question_id: 16, selected_option: "Yes" },
    { question_id: 17, selected_option: "Yes" },
    { question_id: 18, selected_option: "Yes" },
