  ...
  return (
   ...
   {/* className="min-h-screen bg-white flex flex-col items-center pt-12" */}
    ...
    <div className="max-h-screen  flex flex-col items-start pt-12 ">
      <h1 className="text-3xl font-bold text-gray-800 mb-6 ml-12">Well Done!</h1>
      <p className="text-lg text-gray-700 mb-2 ml-12">You have Successfully Completed the test.</p>
      <p className="text-lg text-gray-700 mb-8 ml-12">Please Enter Your Details to Get the Report of the Assessment</p>
...
<input
        ...
        <button
          type="submit"
          className="w-fit p-6 ml-12 bg-gray-800 text-white text-lg font-semibold rounded-md hover:bg-gray-900"
        >
          Submit & Get Report
        </button>
      </form>
